...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(1275, 639));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        }else if(!"admin".equals(username) && password!="admin"){
             JOptionPane.showMessageDialog(this, "Invalid Username/Password Entered", "Error", JOptionPane.ERROR_MESSAGE);
        }else{
               dispose();
                Dash d = new Dash();
                d.setTitle("Dashboard Page");
                d.setVisible(true);
        }
